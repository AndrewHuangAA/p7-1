...
class ConnectUserDB(object):
    ...
    def __init__(self):
        ...
        # with open ("/Users/andrew/Documents/i_chun_new/distance_method/distance_method/config/correlation_db.json", 'r')as f:
        with open ("/Users/andrew/Documents/Django/Lab_Training/Lab_Training/config/correlation_db.json", 'r')as f:
